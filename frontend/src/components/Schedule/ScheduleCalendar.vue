                        ...
                        >
                          ...
                          >
                            ...
                            <v-btn
                              variant="text"
                              color="secondary"
                              @click="$refs.menu3.save(targetDate)"
                            >
                              OK
                            </v-btn>
                          </v-date-picker>
    ...
    >
      <v-card>
          ...
          >
            ...
            >
              ...
              <v-btn
                variant="text"
                color="secondary"
                @click="$refs.editCalender.save(targetDate)"
              >
                OK
              </v-btn>
            </v-date-picker>
        ...
        <v-card-actions>
          <v-btn
            color="primary"
            @click="finishEditTarget()"
          >
            Edit target
          </v-btn>
          <v-btn
            color="error"
            @click="closeEditTarget()"
          >
            Cancel
          </v-btn>
          <v-btn
