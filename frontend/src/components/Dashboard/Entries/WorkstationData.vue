  ...
  export default {
    ...
    methods: {
      ...
      initTimeWindowChart (data) {
        ...
        this.charts.timeWindow = new Chart(document.querySelector('#count-by-time-window'), {
          type: "line",
          data: {
            datasets: [{
      ...
      initWorkstationChart (data) {
        ...
        this.charts.workstation = new Chart(document.querySelector('#count-by-workstation'), {
          type: "line",
          data: {
      ...
      initHourChart (data) {
        ...
        const time_data = intervals.map(intervalStart => {
          const count = data.reduce((acc, curr) => {
            const closedAt = curr.closedAt ? curr.closedAt.split(':') : []
        ...
        this.charts.hour = new Chart(document.querySelector('#count-by-hour'), {
          type: "line",
          data: {
