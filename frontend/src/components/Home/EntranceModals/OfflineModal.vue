<template>
  <v-dialog :model-value="entryModal" max-width="1250px" persistent>
    <v-card>
...
LTI-PC
                ...
                <div
                  class="flex items-center justify-center col-span-3 px-2 text-xs text-center col-start-16 lg:text-base"
                >
